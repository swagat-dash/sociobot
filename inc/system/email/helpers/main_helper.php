...
if(!function_exists("send_mail")){
	function send_mail($type, $uid){
		...
		$variables = [
            ...
            "{website_name}" => get_option('website_title', 'SocioBot - Social Media Management And Automation '),
		...
		try {
		    ...
		    //Recipients
		    $mail->setFrom(get_option('email_from', 'example@gmail.com'), get_option('email_name', 'SocioBot'));
		    $mail->addAddress( get_email($uid), get_full_name($uid));
		    $mail->addReplyTo(get_option('email_from', 'example@gmail.com'), get_option('email_name', 'SocioBot'));
