...
<!-- Breadcrumb Area-->
<div class="breadcrumb-area bg-img bg-black-overlay section_padding_130" style="background-image: url(<?php _e( get_theme_frontend_url('assets/img/testimonials.jpg'))?> );">
  <div class="container">
