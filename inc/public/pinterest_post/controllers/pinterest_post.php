<?php
class pinterest_post extends MY_Controller {
	...
	public function index($page = "", $ids = "")
	{
		...
		$block_file_photo = Modules::run("file_manager/block_file", "single", "image", "upload_photo");
		$block_group = Modules::run("group_manager/block_group");
		$block_preview = Modules::run("post/block_preview", [get_class($this)]);
		$block_accounts = Modules::run("post/block_accounts", "pinterest");
